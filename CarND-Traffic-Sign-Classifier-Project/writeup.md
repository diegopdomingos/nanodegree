...
[image2]: ./writeup/grayscale.jpg "Grayscaling"
[image3]: ./writeup/random_noise.jpg "Random Noise"
[image4]: ./writeup/internet_images.png "Traffic Sign 1"
...
The number of ephocs was chosen by checking the history of large trainings (ephocs = 90, 100, etc) and I noticied that it stops increasing approximately in the 25th iteraction.
...
The model was able to correctly guess 3 of the 5 traffic signs, which gives an accuracy of 60%. This is significantly lower than the test set. This can be explained since there are some noises in the images downloaded over the internet that maybe is not in the dataset. One thing that we can try is adding some random noises (rotation, shifting, white noises, etc) to the training data set. This augmentated dataset can increase the chance of sucess in these new images.
